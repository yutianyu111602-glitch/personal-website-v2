...
export const ShaderPreviewButton = ({ 
  ...
  return (
    <motion.button
      ...
      className="w-12 h-12 rounded-full cursor-pointer border-2 overflow-hidden relative backdrop-blur-sm"
      style={{ 
        borderColor: isSelected ? 'rgba(255, 255, 255, 0.8)' : 'rgba(255, 255, 255, 0.3)',
        boxShadow: isSelected ? '0 0 20px rgba(255, 255, 255, 0.4)' : '0 0 10px rgba(255, 255, 255, 0.1)'
      }}
      onClick={onSelect}
